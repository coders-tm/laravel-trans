...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Path to the base language JSON files (e.g. resources/lang).
    | Defaults to base_path('resources/lang').
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Path where runtime translation overrides are stored (e.g. via update()).
    | Defaults to storage_path('lang').
    |
    */

    'storage_path' => storage_path('lang'),
